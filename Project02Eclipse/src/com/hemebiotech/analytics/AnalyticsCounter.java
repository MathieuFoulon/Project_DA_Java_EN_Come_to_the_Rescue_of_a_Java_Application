...
public class AnalyticsCounter {
    ...
    /**
     * Basically a Mapper method, instance of a TreeMap for sorting purpose, and processes to count number of occurrences to map it to the symptom.
     * @param symptomsList , a string list of symptoms
     * @return symptomsMapped , TreeMap object of the list of symptoms mapped with the number of occurrences found on the symptomsList
     */
